...
|---|---|---|---|---|
| 프레임워크/라이브러리 | React | 19.2.1 | MIT | (2025-12-08 업데이트, React2Shell 보안 패치 및 고정) |
...
### **주요 업데이트 내역 (2025-12-08)**

- **React**: 19.2.0 → 19.2.1 (React2Shell 취약점으로 인한 보안 업데이트. 19.2.1 이상 버전 고정)
- **React-DOM**: 19.2.0 → 19.2.1
- **Package.json**: `overrides` 설정을 통해 React 버전이 19.2.1 미만으로 내려가지 않도록 강제
