...
export type AcademyField = '프론트엔드' | '백엔드' | '풀스택' | '웹개발' | '모바일' | '데이터/AI' | 'AI/머신러닝' | '클라우드운영' | '클라우드·보안' | 'Infra운영' | '보안' | 'IoT/임베디드' | 'IoT·임베디드·반도체' | '게임/블록체인' | '게임·블록체인' | '데이터엔지니어링' | '데이터분석' | '빅데이터' | 'DB' | 'SW아키텍처' | 'SW구조' | '정보보안전문가' | 'IT기획/컨설팅' | '기획·마케팅·기타' | '디자인·3D' | '프로젝트·취준·창업' | '전체';
